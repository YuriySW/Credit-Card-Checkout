...
(function(modules, entry, mainEntry, parcelRequireName, globalName) {
    ...
    "4tqEw": [
        function(require, module1, exports1, __globalThis) {
            ...
            module1.bundle.HMR_BUNDLE_ID = "a0efe10c09abd0a0";
            "use strict";
...
${frame.code}`;
    ...
    "83FZ8": [
        ...
        {
            "../script/modules/render.js": "cwsVY"
        }
    ],
    "cwsVY": [
        function(require, module1, exports1, __globalThis) {
            ...
            parcelHelpers.export(exports1, "renderApp", ()=>renderApp);
            var _redom = require("redom");
            var _cardJs = require("./card.js");
            var _createElementJs = require("./createElement.js");
            function renderApp(container) {
                const cardContainer = (0, _redom.el)('div.card', _cardJs.secureText, _cardJs.creditCard, _createElementJs.form);
        ...
        },
        {
            "redom": "cWIuY",
            "./card.js": "5UD9c",
            "./createElement.js": "5m3yY",
            "@parcel/transformer-js/src/esmodule-helpers.js": "fD7H8"
        }
    ],
    "cWIuY": [
        function(require, module1, exports1, __globalThis) {
            (function(global1, factory) {
                ...
                function unmount(parent, child) {
                    ...
                    if (child === childEl && childEl.__redom_view) child = childEl.__redom_view;
    ...
    "5UD9c": [
        function(require, module1, exports1, __globalThis) {
            var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
            parcelHelpers.defineInteropFlag(exports1);
            parcelHelpers.export(exports1, "cardNumber", ()=>cardNumber);
            parcelHelpers.export(exports1, "cardName", ()=>cardName);
            parcelHelpers.export(exports1, "cardDate", ()=>cardDate);
            parcelHelpers.export(exports1, "cardPersonal", ()=>cardPersonal);
            parcelHelpers.export(exports1, "creditCard", ()=>creditCard);
            parcelHelpers.export(exports1, "secureText", ()=>secureText);
            var _redom = require("redom");
    ...
    "5m3yY": [
        function(require, module1, exports1, __globalThis) {
            var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
            parcelHelpers.defineInteropFlag(exports1);
            parcelHelpers.export(exports1, "createInputField", ()=>createInputField);
            parcelHelpers.export(exports1, "form", ()=>form);
            var _redom = require("redom");
            ...
            const form = (0, _redom.el)('form.form#form', (0, _redom.el)('div.form__input-wrap.form__input-wrap_holder', (0, _redom.el)('label.form__label.form__holder-label', 'Card Holder'), createInputField({
                ...
                onInput: _handlersJs.handleNameInput
                ...
                maxLength: 19,
                onInput: _handlersJs.handleCardNumberInput
                ...
                placeholder: 'MM/YY',
                maxLength: 5,
                onInput: _handlersJs.handleDateInput
                ...
                placeholder: '***',
                maxLength: 3,
                onInput: _handlersJs.handleCvvInput
    ...
    "4qy9P": [
        function(require, module1, exports1, __globalThis) {
            ...
            //   }
            // }
            parcelHelpers.export(exports1, "handleNameInput", ()=>handleNameInput);
            parcelHelpers.export(exports1, "handleCardNumberInput", ()=>handleCardNumberInput);
            parcelHelpers.export(exports1, "handleDateInput", ()=>handleDateInput);
            parcelHelpers.export(exports1, "handleCvvInput", ()=>handleCvvInput);
            var _cardJs = require("./card.js");
            function handleNameInput(event) {
                ...
                const limitedWords = trimmedWords.slice(0, 2);
                const limitedValue = limitedWords.join(' ');
                _cardJs.cardName.textContent = limitedValue || 'John Doe';
                event.target.value = limitedValue;
            }
            function handleCardNumberInput(event) {
                ...
                _cardJs.cardNumber.textContent = event.target.value || 'xxxx xxxx xxxx xxxx';
            }
            function handleDateInput(event) {
                ...
                _cardJs.cardDate.textContent = value || 'MM/YY';
            }
    ...
    "4tqEw",
    "83FZ8"
], "83FZ8", "parcelRequire94c2");

//# sourceMappingURL=index.e9479f46.js.map

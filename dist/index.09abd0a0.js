...
})({"9nVjA":[function(require,module,exports,__globalThis) {
...
const form = (0, _redom.el)('form.form#form', (0, _redom.el)('div.form__input-wrap.form__input-wrap_holder', (0, _redom.el)('label.form__label.form__holder-label', 'Card Holder'), (0, _redom.el)('input.input.input__holder', {
    type: 'text',
    placeholder: 'Enter card holder name',
    oninput: handleNameInput
})), (0, _redom.el)('div.form__input-wrap.form__input-wrap_number', (0, _redom.el)('label.form__label.form__number-label', 'Card Number'), (0, _redom.el)('input.input.input__number#cardNumber', {
    type: 'text',
    placeholder: 'xxxx xxxx xxxx xxxx',
    maxlength: 19,
    oninput: handleCardNumberInput
})), (0, _redom.el)('div.form__input-wrap.form__input-wrap_date', (0, _redom.el)('label.form__label.form__date-label', 'Card Expiry'), (0, _redom.el)('input.input.input__date', {
    type: 'text',
    placeholder: 'MM/YY',
    maxlength: 5,
    oninput: handleDateInput
})), (0, _redom.el)('div.form__input-wrap.form__input-wrap_cvv', (0, _redom.el)('label.form__label.form__cvv-label', 'CVV'), (0, _redom.el)('input.input.input__cvv', {
    type: 'text',
    placeholder: '***',
    maxlength: 3,
    oninput: handleCvvInput
})), (0, _redom.el)('button.form__button', 'CHECK OUT'));
const cardContainer = (0, _redom.el)('div.card', secureText, creditCard, form);
const app = (0, _redom.el)('div.wrapper', cardContainer);
(0, _redom.mount)(document.body, app);
function handleNameInput(event) {
    const value = event.target.value;
    if (/^[a-zA-Z\s]*$/.test(value)) cardName.textContent = value || 'John Doe';
    else event.target.value = value.slice(0, -1);
}
...
},{}]},["9nVjA","83FZ8"], "83FZ8", "parcelRequire94c2")
